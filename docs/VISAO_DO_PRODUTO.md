...
- **Birds:** comunidade de alunos da Bluebird.
- **Bloo:** personagem/avatar evolutivo do aluno dentro do BirdLeague. Pronúncia sugerida: "blú".
- **BirdLeague:** experiência gamificada onde os Birds treinam e fazem seus Bloos evoluírem.
...
- Parado.
- Feliz.
- Triste ou reagindo a erro de forma leve.
- Comemorando.
- Correndo ou voando.
- Pensando.
